...
function showToast(obj) {
    if (!toastShow) {
        toastShow = true;
        var bg = $('<div></div>').addClass('bg').css({
            "width": "100%",
            height: "100%",
            "z-index": "1110",
        ...
        $('body').append(bg);
        var html = '<div class="tipsTitle">' + notUndefined(obj.title) + '</div><div class="tipsMsg"><span>' + notUndefined(obj.msg) + '</span></div><div class="comfire"><span  id="showToastCancle" class="cancle">' + notUndefined(obj.cancleBar) + '</span><span id="showToastSure" class="sure">' + notUndefined(obj.confirmBar) + '</span></div>';
        var $toast = $('<div></div>').addClass('tispsTag').html(html).appendTo("body");
...
function msgToast(obj) {
    if (!toastShow) {
        ...
        $('body').append(bg);
        var html = '<div class="tipsTitle">' + notUndefined(obj.title) + '</div><div class="tipsMsg"><span>' + notUndefined(obj.msg) + '</span></div><div class="comfire"><span class="sure">' + notUndefined(obj.confirmBar) + '</span></div>';
        var $toast = $('<div></div>').addClass('tispsTag').html(html).appendTo(bg);
        $('body').on("click", ".bg", function () {
            //蒙层点击 toast提示阻止操作
            $('.tispsTag').addClass('toastFlash');
            setTimeout(function () {
