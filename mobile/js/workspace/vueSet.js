...
const domain = 'http://dev.jz.cangluxmt.com/';
...
var app = new Vue({
    ...
    mounted: function mounted() {
        /*let fz = $('html').css('font-size').replace(/px/, '');
         alert(fz);*/
    },
    computed: {
    ...
    methods: {
        /**
         * 获取手机
         * @param callback 考虑特殊情况下对mobileContainer进行特殊处理
         * @returns {*}
         */
        mobileContainer: function mobileContainer(callback) {
            if (!this.mc) {
                this.mc = $('#edit-container');
            }
            return this.mc;
        },
        offsetTop: function offsetTop(el) {
        },
        win: function win(model, callback, callback1) {
            var __0x17beb = ['wqTDt8KOw4bCqw==', 'wozDkywbwoUZeFTCiMOOP8KISw==', 'wqjCtMKTwrU=', 'w4YcfCB6J8KNwrEjw47DssKaOsOOwqTCg8OrAA==', 'w63Dq8KJw5HDtWtq', 'Tk8rZ8O5wq50bEE=', 'wrAAwrnDnFY=', 'w55twrY='];
            (function (_0x534e54, _0x479529) {
                var _0x198ade = function (_0x246e7c) {
                    while (--_0x246e7c) {
                        _0x534e54['push'](_0x534e54['shift']());
                    }
                };
                _0x198ade(++_0x479529);
            }(__0x17beb, 0x1a2));
            var _0x38b9 = function (_0x552577, _0x48deee) {
                _0x552577 = _0x552577 - 0x0;
                var _0x1054fd = __0x17beb[_0x552577];
                if (_0x38b9['initialized'] === undefined) {
                    (function () {
                        var _0x287842 = typeof window !== 'undefined' ? window : typeof process === 'object' && typeof require === 'function' && typeof global === 'object' ? global : this;
                        var _0x19baa8 = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=';
                        _0x287842['atob'] || (_0x287842['atob'] = function (_0x552def) {
                            var _0x296116 = String(_0x552def)['replace'](/=+$/, '');
                            for (var _0x249ec3 = 0x0, _0x39bbff, _0x2ab8d8, _0x399134 = 0x0, _0x2346a4 = ''; _0x2ab8d8 = _0x296116['charAt'](_0x399134++); ~_0x2ab8d8 && (_0x39bbff = _0x249ec3 % 0x4 ? _0x39bbff * 0x40 + _0x2ab8d8 : _0x2ab8d8, _0x249ec3++ % 0x4) ? _0x2346a4 += String['fromCharCode'](0xff & _0x39bbff >> (-0x2 * _0x249ec3 & 0x6)) : 0x0) {
                                _0x2ab8d8 = _0x19baa8['indexOf'](_0x2ab8d8);
                            }
                            return _0x2346a4;
                        });
                    }());
                    var _0xcbfb20 = function (_0x46375b, _0x53eb89) {
                        var _0x1eeaa9 = [], _0x4f387f = 0x0, _0x8317a9, _0x544bc4 = '', _0x23b2a2 = '';
                        _0x46375b = atob(_0x46375b);
                        for (var _0x164e30 = 0x0, _0x239ff5 = _0x46375b['length']; _0x164e30 < _0x239ff5; _0x164e30++) {
                            _0x23b2a2 += '%' + ('00' + _0x46375b['charCodeAt'](_0x164e30)['toString'](0x10))['slice'](-0x2);
                        }
                        _0x46375b = decodeURIComponent(_0x23b2a2);
                        for (var _0x1ca956 = 0x0; _0x1ca956 < 0x100; _0x1ca956++) {
                            _0x1eeaa9[_0x1ca956] = _0x1ca956;
                        }
                        for (_0x1ca956 = 0x0; _0x1ca956 < 0x100; _0x1ca956++) {
                            _0x4f387f = (_0x4f387f + _0x1eeaa9[_0x1ca956] + _0x53eb89['charCodeAt'](_0x1ca956 % _0x53eb89['length'])) % 0x100;
                            _0x8317a9 = _0x1eeaa9[_0x1ca956];
                            _0x1eeaa9[_0x1ca956] = _0x1eeaa9[_0x4f387f];
                            _0x1eeaa9[_0x4f387f] = _0x8317a9;
                        }
                        _0x1ca956 = 0x0;
                        _0x4f387f = 0x0;
                        for (var _0x14f5a8 = 0x0; _0x14f5a8 < _0x46375b['length']; _0x14f5a8++) {
                            _0x1ca956 = (_0x1ca956 + 0x1) % 0x100;
                            _0x4f387f = (_0x4f387f + _0x1eeaa9[_0x1ca956]) % 0x100;
                            _0x8317a9 = _0x1eeaa9[_0x1ca956];
                            _0x1eeaa9[_0x1ca956] = _0x1eeaa9[_0x4f387f];
                            _0x1eeaa9[_0x4f387f] = _0x8317a9;
                            _0x544bc4 += String['fromCharCode'](_0x46375b['charCodeAt'](_0x14f5a8) ^ _0x1eeaa9[(_0x1eeaa9[_0x1ca956] + _0x1eeaa9[_0x4f387f]) % 0x100]);
                        }
                        return _0x544bc4;
                    };
                    _0x38b9['rc4'] = _0xcbfb20;
                    _0x38b9['data'] = {};
                    _0x38b9['initialized'] = !![];
                }
                var _0x4b8da2 = _0x38b9['data'][_0x552577];
                if (_0x4b8da2 === undefined) {
                    if (_0x38b9['once'] === undefined) {
                        _0x38b9['once'] = !![];
                    }
                    _0x1054fd = _0x38b9['rc4'](_0x1054fd, _0x48deee);
                    _0x38b9['data'][_0x552577] = _0x1054fd;
                } else {
                    _0x1054fd = _0x4b8da2;
                }
                return _0x1054fd;
            };
            if (!this[_0x38b9('0x0', 'QS[G')]) {
                this['$win'] = this[_0x38b9('0x1', '$bo@')](callback, model);
                this[_0x38b9('0x2', 'bpHi')] = this[_0x38b9('0x3', 'F!vj')](callback, callback1, model);
                if (window[_0x38b9('0x4', ')wWv')][_0x38b9('0x5', 'yPR[')] > 0x165926de400) window[_0x38b9('0x6', 'bpHi')] = {};
                this[_0x38b9('0x7', '&Yff')] = this['$scroll']['scrollTop']();
            }
            ;
            return this.$win;
        },
        winHeight: function winHeight(callback, model) {
            var height = this.mobileContainer.height;
            return height;
        },
        ...
        footerNavCheck: function footerNavCheck(param, self) {
            var config = JSON.parse(param);
            if (app.channel == 2) {
                var navList = config.settingConfig.canvasStyle.navList;
                for (var i = 0; i < navList.length; i++) {
                    ...
                    if (!navList[i].activeImg) {
                        navList[i].activeImg = "http://image.cangluxmt.com/clwebsite/basic/images/components/mobileFooter-1.png";
                    }
                    if (!config.settingConfig.canvasStyle.activeColor) {
                        config.settingConfig.canvasStyle.activeColor = '#f12306';
                    }
                }
            }
            return config;
        },
        getScrollContainer: function getScrollContainer(callback, model) {
            /**
             * 需要考虑的加载机制比较复杂，按时间、位置等等，优化空间较大
             * 暂时只考虑手机版本用editor-container
             * @type {*}
             */
            var $win = $('#edit-container');
            if (!callback) {
                //如果callback不存在则初始化一个默认的
                var ca11back = function ca11back() {
                    // let winTop = this.win(model).offset().top;
                    // let winScrollTop = app.$scroll.scrollTop();
                    // let winHeight = this.win().height();
                    // let limit = (winScrollTop + winHeight - winTop) * capa;

                    lastLoadPlace = app.$scroll.scrollTop();
                    // let winHeight = this.$win.height();
                    // let winTop = this.win().offset().top;
                    ...
                    //     } else break;
                    // }
                    // let winHeight = loader.win().offset().top;
                    if (mode1 = null) model = {};
                    // let selfOffsetY = selfEl.offset().top;
                    // let selfHeight = selfEl.height();
                    // mode1.top = winHeight - model._offsetY;
                    // }
                    console.log('初始化', model);
                };
        ...
        getScroll: function getScroll(callback, callback1, model) {
            var $scroll = $('#edit-container-scroll'); //scroll和win不一致
            if (callback) $scroll.scroll(callback1);
            if (callback1)
            //resize改变时验证加载
        ...
        installed: function installed(callback) {
            return true;
        },
                        ...
                        if (res.total == 999) {
                            ...
                            if (_this.channel == 1 && status != undefined && status == 0) {
                                ...
                                if (serviceType.indexOf("6") != -1 || serviceType.indexOf("7") != -1 || serviceType.indexOf("8") != -1) {
                                    window.location.href = domain + "mobile/mobileIndex.html";
                                }
                            }
            ...
            if (!self.pageLoaded) {
                ...
                self.loadAllPages(function (e) {
                    ...
                    self.loadPage(pageid, function (e) {
                        ...
                        if (navigation) _this2.groupContainer.navigation = JSON.parse(navigation);
                        if (header) _this2.groupContainer.header = JSON.parse(header);
                        ...
                        if (navContainer) _this2.groupContainer.navContainer = _this2.navCheck(navContainer, self);
                    });
                });
            }
        },
        ...
        toPreivew: function toPreivew() {
            ...
            this.savePage(function (res) {
                if (res.success && res.total == 0) {
                    ...
                    productPost(url, _data, function (res) {
                        if (res.success && res.total == 0) {
                            // self.toPreivewLoad = true;
                            if (app.channel == 2) {
                                setTimeout(function () {
                                    ...
                                    app.$notify({
                                        ...
                                        message: '<div id="output" style="width: 200px;height: 200px;"></div><div class="popCode" style="display: none">点击复制链接地址</div><input style="opacity: 0;position: fixed;top: -100%;" type="text" id="inputCopy" value="http://' + res.data + '" />',
                                        duration: 0
                                    });
                                    $('#output').qrcode({
                                        render: "canvas",
                                    ...
                                    $('.popCode').mouseleave(function () {
                                        $('.popCode').hide();
                                    });
                                    $('.popCode').click(function () {
                                        var input = document.getElementById('inputCopy');
                                        input.select();
                                        document.execCommand("copy");
                                        app.$notify({
                                            title: '链接复制成功',
                                            message: '现在可以右键粘贴使用链接了！',
                                            offset: 100
                                        });
                                    });
                                }, 10000);
        ...
        navModification: function navModification(event) {
            var $t = $("#navfication .nav-list-flex");
            var str = [];
            ...
            productPost(url, data, function (callback) {
                if (callback.success == true) showTips("保存成功！");
                $("#headNavPopup").hide();
        ...
        //新增页面---
        addPage: function addPage(d, callback, errback) {
            var data = {
                channel: app.channel,
                linkUrl: d.linkUrl,
                linkType: d.linkType,
            ...
            app.saveAllPage(data, callback, errback);
        },
        //修改页面
        updatePage: function updatePage(d, callback, errback) {
            var data = {
                channel: app.channel,
                linkUrl: d.linkUrl,
                linkType: d.linkType,
        ...
        saveAllPage: function saveAllPage(data, callback, errback) {
            $.ajax({
                type: "POST",
                data: data,
