 ...
 */
define(function () {
    return ['widget/cart-item', 'widget/menu-item', 'widget/submenu', 'widget/navi', 'widget/hr-line', 'widget/hover-image', 'header/nav-container', 'header/navigation', 'tools/modulelist', 'tools/palette-item', 'tools/tpl', 'tools/my-tpl', 'lantern', 'cptborder', 'href', 'header/theme', 'dialog/text', 'save-template', 'header/header-left', 'header/header-center', 'header/header', 'page-navi-mobile', 'guide/guide-new', 'footer/mobile-footer', 'group-container', 'edit-container'];
});