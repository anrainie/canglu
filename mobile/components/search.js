...
define([], function () {
    return _defineProperty({
        ...
        mounted: function mounted() {
            if (this.model.type >= 8) {
                this.model.type = this.model.type - 8;
            }
            ...
            refresh: function refresh() {
                ...
                setTimeout(function () {
                    ...
                    if (_this2.model.type < 3) {
                        ...
                        if (inner && _this2.model.type != 0) {
                            if (inner) {
                                $(inner).css({
                                    border: '1px solid #ccc'
                                });
                            }
                        } else if (_this2.model.type == 0) {
                            if (inner) {
                                $(inner).css({
                                    border: '1px solid ' + color
                                });
                        ...
                        } else if (_this2.model.type == 6) {
                            if (inner) {
                                $(inner).css({
                                    'border-radius': '20px'
                                });
                            }
                        } else if (_this2.model.type == 7) {
                            if (inner) {
                                $(inner).css({
                                    'border': 'none',
                                    'border-radius': '0',
