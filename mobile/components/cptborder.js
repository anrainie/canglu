    ...
    return {
        ...
        computed: {
            ...
            contentStyle: function contentStyle() {
                var height = '100%';
                if (this.model.titleBarStyle.show) {
                ...
                if (this.model.backgroundStyle['background-color'] == null) this.model.backgroundStyle['background-color'] = 'transparent';
                var x = {
            ...
            positionStyle: function positionStyle() {
                ...
                var flag = ['font', 'add-picture', 'button-type'];
                if (app.isPreview) {
                    var fz = 16;
                    pos.x = pos.x.replace(/px/, '') / fz + 'rem';
                    pos.y = pos.y.replace(/px/, '') / fz + 'rem';
                    pos.w = pos.w.replace(/px/, '') / fz + 'rem';
                    pos.h = pos.h.replace(/px/, '') / fz + 'rem';
                }
                if (flag.indexOf(this.model.__componentType) < 0 || parseInt(this.model.style.width.replace(/px/, '')) > 350) {
                    pos.w = '100%';
                }
        ...
        watch: {
            ...
            'model.style': {
                handler: function handler(newValue, ov) {
                    // this.$forceUpdate();
                },
        ...
        mounted: function mounted() {
            ...
            } else if (this.model.__componentType == 'productDetails' || this.model.__componentType == 'articleDetails') {
                handler = '';
                Maxis = '';
                mleft = 0;
                isDisabled = true;
        ...
        methods: {
            ...
            beforeDestroy: function beforeDestroy(callback) {
                callback && callback();
                // alert(123);
            },
