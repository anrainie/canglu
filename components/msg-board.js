        ...
        props: {
            model: {
                default: (_default = {
                    ...
                    'background-color': '#fff',
                    'background-image': ''
                }), _defineProperty(_default, 'type', 0), _defineProperty(_default, 'buttonImg', 'line-item has-border blue-color'), _defineProperty(_default, 'message', ''), _defineProperty(_default, 'name', ''), _defineProperty(_default, 'phone', ''), _defineProperty(_default, 'email', ''), _defineProperty(_default, 'style', {
                    width: '60%',
                    height: '500px'
                }), _default)
            }
                            ...
                            type: {
                                config: {
                                    ...
                                    options: [{
                                        ...
                                        channel: 1,
                                        image: 'images/components/teshu2.png',
                                        text: '1'
                                    }]
                                },
