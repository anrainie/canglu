...
define(['vueLoader'], function (loader) {
    return {
        ...
        computed: {
            ...
            textContainerStyle: function textContainerStyle() {
            ...
            iconBgStyle: function iconBgStyle() {
                var x = {};
                switch (this.model.type) {
                    case 1:
                    case 3:
            ...
            iconContainerStyle: function iconContainerStyle() {
                var x = {};
                switch (this.model.type) {
                    case 0:
                    case 1:
        ...
        methods: {
            goShop: function goShop() {
                if (app.isPreview) {
                    window.location.href = "http://" + app.saveParams.domainUrl + "/cart/detail.html";
                }
            }
        },
        data: function data() {
