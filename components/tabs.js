    ...
    return {
        ...
        computed: {
            barStyle: function barStyle() {
                return {
                    'width': this.model.type == 1 ? this.model.barStyle.width + 'px' : '100%',
            ...
            'model.tabs.length': {
                handler: function handler() {
                    if (this.model.tabs.length > 0) {
                        this.activePanel = this.model.tabs[0].name;
                    }
                },
        ...
        methods: {
            ...
            tabStyle: function tabStyle(name) {
                ...
                var r = {
                    width: this.model.tabStyle.width + 'px',
                    height: this.model.tabStyle.height + 'px',
                    ...
                    'margin-bottom': this.model.type == 1 ? this.model.tabStyle['margin-left'] + 'px' : 0,
            ...
            hover: function hover(e) {
                ...
                var color = this.model.tabSelectedStyle["background-color"];
                var img = this.model.tabSelectedStyle['background-image'];
                if (ele.hasClass('tabsHover')) {
                    this.HC = ele.css('background-color');
                    this.IMG = ele.css('background-image');
                    ele.css({
