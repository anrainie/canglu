...
define(['vueLoader'], function () {
    return {
        ...
        watch: {
            'model.floorListId': function modelFloorListId() {
            ...
            'model.selectClass': function modelSelectClass() {
                var _this = this;
                ...
                app.loadGoodsList({
                    ...
                    if (arr.length < 8) {
                        for (var i = 0; i < arr.length; i++) {
                            if (arr[i] != undefined && arr[i] != null) {
                                var oldImg = arr[i].product.masterImg;
                                if (oldImg.indexOf('middle') == -1) {
                                    ...
                                    arr[i].product.masterImg = imgSrc;
                                }
                            }
                    ...
                    _this.model.goodsList = goodsList;
                });
            }
        },
